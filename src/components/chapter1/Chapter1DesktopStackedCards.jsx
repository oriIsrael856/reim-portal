...
export default function Chapter1DesktopStackedCards({ data, stickyReleaseRef, ch1 }) {
    ...
    return (
        <div className="flex w-full min-w-0 flex-col" style={{ ...ch1?.cardsStackGap, ...ch1?.cardsStackPb }}>
            {c0 ? (
                <StickyCard top={ch1?.stickyTop?.top ?? '132px'} programCard programExpandToContent>
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-3 self-stretch">
                            <div className="flex w-full flex-col items-stretch gap-3 self-stretch">
                                ...
                                <p className="max-w-[712px] self-start text-right font-normal leading-[1.32] tracking-[0.009375em] text-[#001D26] whitespace-pre-line" style={ch1?.cardBodyFont}>
                                    {c1.sec1Text}
                                </p>
                            </div>
