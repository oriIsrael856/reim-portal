    ...
    return (
        <div className="pt-12 pb-20 text-center px-4 relative overflow-hidden">
            ...
            <div className="relative z-10 mb-12">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-[#2D2D44] leading-tight mb-2">
                    {data.title1}
                </h1>
                <div className="relative inline-block">
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-[#5E3BEE] leading-tight relative z-10">
                        {data.title2}
                    </h1>
            ...
            <div className="flex justify-center items-center gap-3 sm:gap-4 md:gap-6 mt-8 h-[200px] sm:h-[260px] md:h-[320px] relative z-10 max-w-[1400px] mx-auto perspective-1000 overflow-x-auto overflow-y-visible px-2 md:overflow-visible md:px-0">
                {data.images.map((img, i) => {
                    ...
                    return (
                        <div key={i} className="relative transition-all duration-500 hover:z-50 hover:scale-110 shrink-0"
                            ...
                            <div className="p-1.5 sm:p-2 bg-white rounded-2xl shadow-lg border border-gray-100">
                                <div className="w-full h-36 sm:h-48 md:h-64 overflow-hidden rounded-xl bg-gray-200">
